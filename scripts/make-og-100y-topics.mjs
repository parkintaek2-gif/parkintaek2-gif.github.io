...
const 카드들 = [
  ...
  },
  {
    이름파일: 'swimming',
    딱지: '나이대별 수영 참여율',
    이름: '수영은 몇 살이 가장 많이 할까요?',
    수: '50대 8.6%',
    수말: '2025년 · 최근 1년 참여 경험(복수응답, 2021년은 자료 없음)',
    밑: '문화체육관광부 국민생활체육조사 · KOSIS',
  },
  {
    이름파일: 'soccer',
    딱지: '나이대별 축구·풋살 참여율',
    이름: '축구는 몇 살이 가장 많이 할까요?',
    수: '10대 29.4%',
    수말: '2025년 · 최근 1년 참여 경험(복수응답)',
    밑: '문화체육관광부 국민생활체육조사 · KOSIS',
  },
  {
    이름파일: 'parental-leave',
    딱지: '부모 나이대별 육아휴직 사용률',
    이름: '육아휴직은 몇 살 부모가 가장 많이 쓸까요?',
    수: '30세 미만 46.4%',
    수말: '2024년 · 전체 34.7%(어머니 72.2%·아버지 10.2%)',
    밑: '통계청 「출생아 부모의 육아휴직 사용률」 · KOSIS',
  },
  {
    이름파일: 'nursery-fill',
    딱지: '어린이집 정원 대비 현원',
