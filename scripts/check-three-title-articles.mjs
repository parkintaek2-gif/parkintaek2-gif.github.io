...
if (틀림) {
  ...
  const 자료때들 = ["archive/raw/netflix-top10/korean-titles-keyed.json","archive/raw/netflix-top10/korean-cast-joined.json","src/data/wikitip-titles.json"].map(자료의때).filter((d) => d instanceof Date);
