...
export const 면제 = {
  ...
  'wikitip-indexed.json':
    '**구글이 우리 지면을 색인했나**를 구글에게 직접 물어 받은 답이다(URL Inspection API). '
    + '우리 집 사정이지 손님이 볼 표가 아니다 — 「이 지면은 색인이 안 됐습니다」를 그 지면에 쓸 수 없다. '
    + '⛔ 「아직 지면을 안 만들었다」가 아니라, 낼 자리가 아니라고 정한 것이다. '
    + '이 수로 정한 일(안쪽 링크 늘리기)의 결과는 4주 뒤 같은 자로 다시 재서 확인한다.',
