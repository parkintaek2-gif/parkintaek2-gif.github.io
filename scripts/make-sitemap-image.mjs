...
const 사이트 = [
  {
    ...
    네이버: 0,
    값: [
      { 무엇: '지역 한 벌 (구 단위 · 10곳 이상)', 얼마: '9,900원', 상태: '정함', 곁: '99개 구' },
      { 무엇: '학교 한 곳', 얼마: '무료', 상태: '정함', 곁: '이게 지역 한 벌의 광고다' },
      { 무엇: '지역 한 벌 (9곳 이하)', 얼마: '무료', 상태: '정함', 곁: '131개 구 · 적어서 무료라고 밝힌다' },
      { 무엇: '시 지면 (수원시 등)', 얼마: '무료', 상태: '정함', 곁: '구로 보내는 목차' },
      { 무엇: '그 밖 4,619장', 얼마: '무료', 상태: '정함', 곁: '학과·대학·고교 낱장' },
    ],
    말: '값이 정해졌습니다. **여는 날 noindex 를 같이 풉니다** — 무료로 열어도 검색에 없으면 광고가 안 됩니다.',
  },
  {
