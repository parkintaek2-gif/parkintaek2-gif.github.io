 ...
 * ────────────────────────────────────────────────────────────────────────────
 * [🔴 왜 만드나 — 🔴 지시를 어긴 자리가 77곳이었다 (2026-09-03 실측)]
 *
 ...
 *   ```
 *   그 좁은 꼴만 센다. 2026-09-03 실측 **77곳**이다.
 *
 * [⛔ 헛경보를 막으려고 둔 것 — 「기준선」 방식]
 *   77곳을 오늘 다 고칠 수는 없다. 파일이 세 유닛에 걸쳐 있다(100y=3번 · kcw=5번 · korea=6번).
 *   ⛔ 77개를 빨간불로 내면 아무도 안 고치고 자를 끈다. 실제로 이 저장소에서 겪은 일이다 —
 ...
 *   node scripts/check-kst-date.mjs --다찍기     걸린 77곳을 다 본다
 */
