...
export const 신문들 = [
  ...
  { 매체: '매일경제', 갈래: '경제·사회·증권', 몫: ['5번'], 꼴: 'rss',   /* [2026-09-19] 6번·3번 접힘 — 서울마켓츠·백년지도는 5번이 이어받았다 */
  ...
  { 매체: '동아일보', 갈래: '나머지', 몫: ['5번'], 꼴: 'rss',   /* [2026-09-19] 3번 접힘 — 백년지도는 5번이 이어받았다 */
...
function 자가시험() {
  ...
  /* 🔴 [2026-09-22] 이 두 줄이 「매경은 6번·3번」·「동아는 3번만」이었다. 2026-09-19 에
     6번·3번이 접히고 5번이 이어받았는데 **몫만 고치고 시험을 안 고쳐** 자가시험이 사흘 동안
