...
export const 봐줄것 = new Set([
  ...
  '/index',
  /* ⭐ [2026-09-07 · 5번] /tags 는 «주제 목록»이라 길잡이다 — 다른 지면으로 가는 문이고
     자체 자료가 없다. LLM 이 물어갈 것은 그 문 뒤의 자료 지면이라 그쪽을 넣었다.
     ⚠ 오늘 자료 지면 21장을 안내문에 새로 넣었다(99줄 → 120줄). 까닭은
     chatgpt.com 유입 44방문 중 27방문(61%)이 «자료·축 지면»에 내렸기 때문이다. */
  '/tags',
]);
