 ...
 */
export const 유닛들 = [
  { 번호: '1번', 이름: 'K Culture Wire', 도메인: 'www.kculturewire.com', 콘텐트: ['content/kculturewire'], 영상: ['public/wikitip/video'], 카드: ['public/wikitip/cardnews', 'archive/social'] },
  { 번호: '2번', 이름: 'KLifeMap', 도메인: 'klifemap.ai', 콘텐트: [], 영상: [], 지면: ['public'], 저장소: '../klifemap' },
...
if (내가) {
  ...
  쓴다('⚠ 「—」는 0 이 아닙니다 — **그 몫이 없는 자리**이거나 이슈 시계가 없는 지면입니다.', '');
  쓴다('  2번(KLifeMap)은 감명 상품이 본업이라 마크다운 콘텐트 편수 몫이 없고, 5번은 총괄이라', '');
  쓴다('  감수·개발이 몫입니다. 0 으로 적으면 「안 했다」로 읽히므로 «해당 없음»으로 둡니다.', '');
