...
export const 유닛들 = [
  ...
  { 번호: '2번', 이름: 'KLifeMap', 도메인: 'klifemap.ai', 콘텐트: ['content'], 영상: [], 지면: ['public'], 저장소: '../klifemap' },
  ...
  { 번호: '5번', 이름: '총괄(감수·개발)', 도메인: null, 콘텐트: [], 영상: [] },
];
...
if (내가) {
  ...
  const 몫고르기 = (번호) => (줄인유닛.has(String(번호))
    ? { 텍스트: 2, 영상: 1, 기타: 1, 꼬리: ' (3분의 1 · 영상·기타는 사흘에 한 편꼴)' }
    : { 텍스트: 6, 영상: 1, 기타: 1, 꼬리: '' });
