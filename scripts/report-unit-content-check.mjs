...
export const 유닛들 = [
  ...
  { 번호: '1번', 이름: 'K Culture Wire 외 나머지 사이트', 도메인: 'www.kculturewire.com',
  ...
  { 번호: '2번', 이름: 'KLifeMap', 도메인: 'klifemap.ai', 콘텐트: ['content'],
    영상: ['public/media'], 카드: ['public/cardnews'], 지면: ['public'], 저장소: '../klifemap' },
