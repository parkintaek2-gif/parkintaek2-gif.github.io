...
export const BY_MARKETS = new Map([
  ...
  /*
   * 🔴 2026-08-25 추가 셋. `check-korean-title-suspects.mjs` 가 후보 156편을 내놓았고,
   *   그중 석이 큰 것부터 한 편씩 «위키데이터에 동명 작품이 있나 + 그 발표해가 차트 시기와
   *   맞나»를 물어 확정했다.
   * ⛔ 156편을 다 넣지 않았다. 아래 셋만 «증거가 두 갈래로 맞은» 것이다 —
   *   ① 시장 무늬(한국 0자리 + 그 나라 쏠림)  ② 그 나라 동명 작품의 발표해가 차트 첫주와 맞음
   *   나머지는 「봤지만 확정 못 함」으로 두었다. 짐작으로 빼면 «맞는 것을 잃는다».
   * ⚠ 그 위험이 실제로 있다 — `Boys Over Flowers` 는 한국 0자리인데 «진짜 한국 드라마»다.
   *   2009년 KBS 작품이 볼리비아 49자리·페루 12자리로 뜬 것이라 안 뺐다.
   *   ⛔ 그러니 「한국 0자리」만으로는 절대 빼지 않는다. 한국 0자리가 384편이다.
   */
  ['Dangerous Liaisons', '프랑스 (한국 없음) — 한국 0자리 · 유럽 54자리 · 아시아 1자리 · '
    + '2022-07-10~07-31 3주뿐. 넷플릭스 프랑스판이 2022-07-08 에 올라왔다. '
    + '⚠ 우리 자료엔 장동건이 붙어 있었다 — 2012년 한중 합작 동명 영화 때문이다'],
  ['Breathless', '스페인 (한국 없음) — 한국 0자리 · 스페인 13·아르헨티나 9·우루과이 9·칠레 8·포르투갈 8. '
    + '위키데이터에 «스페인 2024» 동명 작품이 있고 차트 첫주가 2024-09-01 이다. '
    + '⚠ 한국 동명작은 2009년 영화(똥파리) 하나뿐이라 2024년 스페인어권 진입과 안 맞는다'],
  ['One More Time', '스웨덴 (한국 없음) — 한국 0자리 · 스웨덴이 맨 위. '
    + '위키데이터에 «스웨덴 2023» 동명 작품이 있고 차트가 2023-04-23~05-07 이다'],
]);
