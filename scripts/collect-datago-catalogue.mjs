...
export const 낱말들 = [
  ...
  /* 🔴 [2026-09-09 · 5번] K컬처 낱말 열을 더한다. 사장님: 「케이컬쳐스도 지금보다 훨씬
     좋은 데이터가 어딘가에 있을 것 같다 … 한국콘텐츠진흥원 같은 공기관」
     ⚠ 재 보니 우리가 훑은 낱말 20개에 음악·드라마·게임·웹툰·콘텐츠가 «아예 없었다».
       한류는 13건뿐이었다. 없는 것이 아니라 «안 찾아본» 것이다. */
  { 낱말: '음악', 몫: '5번', 왜: 'K팝의 뿌리 자료 — 음원·공연·저작권' },
  { 낱말: '드라마', 몫: '5번', 왜: '편성·제작 — 넷플릭스 차트 밖의 축' },
  { 낱말: '게임', 몫: '5번', 왜: 'e스포츠 축이 살아 있다(사장님 확인). Riot 없이 잴 길' },
  { 낱말: '웹툰', 몫: '5번', 왜: '이미 kosis 웹툰 자료가 있다. 그 밖에 무엇이 있나' },
  { 낱말: '콘텐츠', 몫: '5번', 왜: '한국콘텐츠진흥원(KOCCA) 자료가 이 낱말에 걸린다' },
  { 낱말: '저작권', 몫: '5번', 왜: '누가 무엇을 갖고 있나 — B2B 손님이 묻는 축' },
  { 낱말: '애니메이션', 몫: '5번', 왜: '수출 축 — 남들이 안 세는 갈래' },
  { 낱말: '공연예술', 몫: '5번', 왜: 'KOPIS 정본 낱말. 「공연」과 다른 결과가 오나' },
  { 낱말: '문화', 몫: '5번', 왜: '문화체육관광부 계열 전체가 이 낱말에 걸린다' },
  { 낱말: '수출', 몫: '5번', 왜: '콘텐츠 수출액 — 「케이컬쳐스 판 니케이」의 거시 축' },
