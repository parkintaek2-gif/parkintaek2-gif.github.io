...
/* 🔴 2026-08-06 — 사장님: 「10일치를 봤는데 왜 몰랐지. 다 외울때까지」
   ...
   ⚠ [2026-08-29 정정] 이 줄이 「하루 세 번(08:30/15:30/20:30)」으로 몇 주째 박혀
     있었는데, 실제로는 8/23에 «하루 한 번, 16시»로 바뀌어 있었다. 낡은 문구가
     매번 브리핑에 떠서 세션들이 옛 규칙으로 알고 있었을 수 있다 — 사장님이
     직접 "최신 버전"으로 확인해 고친다. */
줄.push('🔴 **`docs/사장님-지시-대장.md` 를 읽는다 — 10일 치 원문이다.** 맨 앞의 「상시 의무 색인」만 보고 끝내지 않는다. 색인은 「어디를 보라」이고, 지켜야 할 것은 그 아래 원문이다.');
줄.push('   · 업무보고는 **하루 한 번, 16:00까지** — `docs/보고양식-매일16시.md` 그대로 세션간-메모에 올린다(제목 `[업무보고]`). 개별로 사장님께 직접 올리지 않는다 — 2번이 취합해 원드라이브 저장·메일 발송한다(2026-08-29 확정)');
