...
못잼(
  ...
  '⭐ 2026-08-08 16:4x — **자를 만들었다.** `node scripts/check-100y-phone.mjs` 가 ' +
    ...
    '🔴 8/08 에 이 자가 「파는 표에서 진학·그 밖이 화면 밖」을 잡았다. ' +
    '앞선 「가로 넘침」 검사는 **정직하게 초록**이었다 — 지면은 안 넘쳤고 표만 잘렸다. ' +
    '✅ **2026-08-13 16:5x 에 다시 돌렸다 — 지면 7장·표 14개·길과 단추 6개 · ' +
    '화면 밖 0 · 못 짚을 만큼 낮은 것 0 · exit 0**',
);
...
못잼(
  ...
  '⭐ 2026-08-08 19:0x — **자를 만들었다.** `npm run check:100y:print` 가 진짜 크롬을 A4 에 앉힌다. ' +
    ...
    '✅ **2026-08-13 16:5x 에 다시 돌렸다 — 4장 · 3~4쪽 · 종이 밖 0곳 · 접힌 채 0곳 · 주소줄 찍힘 · exit 0**',
);
