...
if (process.argv.includes('--selftest')) {
  ...
  console.log('✅ collect-100y-fall-injury 자가시험 통과 (15)');
  process.exit(0);
}
...
const 출력 = {
  ...
  출처: {
    ...
    표: '177/DT_11760NP32(성별·연령별) · 177/DT_11760NP33(손상발생장소별) · 177/DT_11760NP34(손상시활동별) · 177/DT_11760NP62(65세 이상 손상기전별 퇴원율 추이)',
    창구: 'KOSIS',
