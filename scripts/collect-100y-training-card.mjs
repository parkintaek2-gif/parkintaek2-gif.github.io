...
async function 만들기() {
  ...
  const 산출 = {
    출처: {
      이름: '한국고용정보원_직업훈련_국민내일배움카드 훈련과정(공공데이터포털, 15109032) / 고용24(work24.go.kr)',
      이용허락범위: '확인 안 함 — 받을 때 이 데이터셋의 이용허락범위를 따로 적어 두지 않았다',
    },
    url: 'https://www.work24.go.kr/hr/a/a/1100/trnnCrsInf.do',
    받은날: yyyymmdd(오늘),
    대조: '못 맞췄다 — 한국고용정보원이 별도로 발표한 내일배움카드 훈련과정 수와 이 실시간 조회 건수를 대조해 본 적이 없다.',
