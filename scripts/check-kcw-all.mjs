...
export const 막는검사 = [
  ...
  /**
   * 🔴 2026-09-11 — JSX 는 «줄바꿈만 있는 틈»을 빈칸이 아니라 없음으로 붙인다.
   *   「15consecutive years」·「theBoth column」·「Top 10have been watched」가 그렇게 나갔다.
   *   나는 이것을 일곱 번 냈고 매번 «눈으로» 잡았다. 눈은 8,322장을 매번 못 본다.
   *   ⇒ 빌드 결과를 훑는 자를 만들어 막는 검사에 올린다. 첫 실행에서 라이브 결함 하나를 잡았다.
   */
  { 자: 'check-kcw-glued-words.mjs', 뭘: '🔴 낱말 두 개가 붙어 나가나 (JSX 가 줄바꿈 틈을 먹는다)', 빌드필요: true },
];
