...
export const 볼것 = [
  ...
  /* ⭐ 2026-08-22 — 날짜가 박힌 자료를 다 훑어 보니 날마다 움직이는 것이 둘 더 있었다.
     ⛔ 나머지(수출·산업·웹툰 통계)는 해마다·철마다 나오는 수라 이 규칙을 걸 자리가 아니다 —
       다 훑어서 규칙을 걸면 안 낡은 것까지 낡았다고 부른다 */
  {
    자료: 'src/data/wikitip-ladder-churn.json',
    날짜칸: 'day',
    지면: ['dist/wikitip/ladder-churn.html'],
    낡음일: 3,
    왜: '사다리에서 누가 빠지고 들어오는지는 날마다 다르다',
  },
  {
    자료: 'src/data/wikitip-ladder-gap.json',
    날짜칸: 'day',
    지면: ['dist/wikitip/ladder-gap.html'],
    낡음일: 3,
    왜: '구간 사이의 점수 차는 날마다 다르다',
  },
];
