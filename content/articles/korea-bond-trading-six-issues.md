...
For anyone building a curve or a fund from Korean bonds, this is the terrain. The daily concentration series here is a [free CSV](/data/korea-bond-concentration.csv) you can reproduce with credit, alongside our [stock concentration data](/data/concentration) and the Treasury [yield curve](/article/korea-government-bond-yield-curve) — every figure dated, ratios not levels.
