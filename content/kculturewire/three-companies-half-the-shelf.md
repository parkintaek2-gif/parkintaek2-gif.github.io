---
title: "Half the Korean series that chart anywhere come from three companies. Count only the makers and it is five."
...
sources:
  ...
  - org: "Netflix"
    api: "Tudum weekly Top 10 country lists, 2021-07-04 to 2026-07-26, used to decide which titles charted"
...
excluded:
  ...
  - "Corporate ownership. Companies inside one group are listed separately because we did not confirm the tree, and merging on a guess would change the answer"
  - "Budget or creative share. A Wikidata credit records that a company is attached, not how much of the work it held"
...
A network airs everything it airs. Counting first-broadcaster credits will look concentrated no
matter what the industry looks like — 28 broadcasters cover 291 series between them, and that is
...
Not that these are the biggest companies, or the best ones. The names on the table behind this piece
are in **alphabetical order** and there is no size column, because the question was how few it takes
and not who is on top. Not that companies inside one corporate group are one company — we did not
confirm the ownership tree, and merging on a guess would move the answer. And not that this is a
census of Korean production: a company whose series never reached a top 10 is simply absent.

The full table, all four credit types, and the coverage figures that limit each of them:
