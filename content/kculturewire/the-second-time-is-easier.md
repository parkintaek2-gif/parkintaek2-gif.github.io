...
category: industry
purpose: both
dek: "A series charts in 33.4% of countries where its company had already charted and 8.6% where it had not. Comparing each series against itself removes age, strength and size, and the gap widens. It reverses in five markets, four English."
pubDate: 2026-08-09
...
excluded:
  ...
  - "59 companies whose catalogue contains only one series that ever charted, because a company with no next series cannot be asked whether the next one was easier"
...
company produced, first broadcast or distributed each Korean title. Join the two — 493,600 chart
...
|---|---:|---:|---:|
| 2–3 series | 44 | 45.0% | 15.7% |
| 4–6 series | 15 | 45.2% | 12.7% |
| 7–12 series | 4 | 51.3% | 12.3% |
| 13 or more | 9 | 29.3% | 4.4% |
...
chart somewhere first. Netflix's country lists grew over the 265 weeks measured here, and Korean
...
436 series can be measured that way.

| Inside one series, on its own weeks | Charted | Chances | Rate |
|---|---:|---:|---:|
| Countries where its company had already charted | 5,350 | 16,025 | **33.4%** |
| Countries where it had not | 2,099 | 24,523 | **8.6%** |

The gap is 24.8 points. It did not shrink when we removed the calendar — it grew slightly, from
3.8× to **3.9×**. Whatever this is, it is not that the world got easier.
...
Splitting by country removes that. Inside Vietnam, every chance faces the same Vietnam. Of the 79
...
Two limits are worth naming plainly. **59 companies are absent from every figure above** — the ones
...
last hit helps the next one, by a factor of four, everywhere except the five markets where your
