---
title: "BigBang is back. For 774 Korean acts, attention halves two months after the peak"
dek: "We found the single best month of 774 Korean acts on English Wikipedia and counted what survived it. The median act fell below half within two months. One group held out 65. BigBang's own last peak halved in one."
category: stars
purpose: both
pubDate: 2026-09-07
...
sources:
  - org: "Wikidata"
    api: "SPARQL — P31/P279* of musical group, musical ensemble, girl group or boy band; South Korea by P495 country of origin, P17 country, or P740 location of formation. No wikibase:label service — it silently drops rows."
...
crossChecks:
  ...
  - "An act needs at least 24 usable months to enter the table. 73 of the 847 acts found had fewer and were dropped rather than counted as zero."
...
in which each was looked up most, and counted what was left afterwards. 847 acts came back
from Wikidata; 774 had enough months to measure.

## The median act loses half of its best month within two months

| | |
| --- | ---: |
| Korean acts measured | **774** |
| Dropped for too few months — *not counted as zero* | 73 |
| Have fallen below half of their peak month | 731 |
| **Median months from peak to half** | **2** |
| Have not fallen below half | 43 |
| …of those, peaked in the most recent month, so had no time to fall | 8 |

Two months is not a long time, and it is not an artefact of small articles either. Among
the 100 acts whose peak month drew 50,000 reads or more, the median is also two months, and
40 of those 100 were already below half in the very next month.

Of the 43 acts that have not halved, only **twelve** are a year or more past their peak.
...
## The twelve that never halved are mostly not idol pop

Sinawe, Can, TRPP, Mot, Target, Achime, The Freaks, Broccoli You Too?, Seaweed Mustache,
Rolling Quartz, BOL4, 3rd Line Butterfly. Sinawe's peak was in May 2020 and it still holds
53.2% of it seventy-five months later.
...
Acts came from Wikidata: anything that is a musical group, musical ensemble, girl group or
boy band (or a subclass of one) tied to South Korea by country of origin, country, or place
of formation, and that has an English Wikipedia article. We do not use Wikidata’s label
service, which drops rows without saying so; names here are English Wikipedia titles. Reads are monthly
...
below half the peak, so one quiet month cannot trigger it. 73 acts had fewer than 24 usable
