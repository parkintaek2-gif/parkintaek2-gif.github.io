...
Korean films get short names. The median film title in the panel is two words and 39% of them are a
single word; the median series title is three words and only 14.1% are one word. Series arrive with
...
A Korean title normally also plays in Korea. Of the 149 shared titles, **75 have never appeared on
...
country, 36 that spread widely but never touched Korea. We will work down it and every removal will
...
**Our series figures are the solid half.** 22.6% name ambiguity, and the biggest series in the panel
...
One of our source files had gone stale. The Korea-signal table was still the 8 August build, so it
still counted *Dangerous Liaisons* — the French film we removed on 25 August — and it had not picked
up titles that charted after that date. Rebuilding it moved the panel from 397 titles to 420, and
every figure in this piece was recounted on the new panel.

What moved: film name-ambiguity from 58.1% to 54.1%, series from 23.6% to 22.6%, the whole panel from
37.5% to 35.5%. The review queue is now 20 one-country titles, 19 concentrated in one country and 36
that spread widely without touching Korea.
