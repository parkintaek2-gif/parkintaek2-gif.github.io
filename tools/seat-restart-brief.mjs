...
export const 다음몫 = {
  ...
  6: [
    '🔴 F1 재무제표 수집기 (목표 09-13) — DART fnlttSinglAcntAll. **병목이 여기 하나다**',
    '   오늘 열리는 것을 확인했다: 삼성전자 229행 · 자산총계·자본총계·매출액·영업이익·당기순이익',
    '   관문: 붙은 수/2,765 를 적는다 · CFS 와 OFS 를 갈라 담는다 · ⛔ 0 으로 채우지 않는다',
    'F2 밸류에이션 표 (목표 09-16) — PER·PBR·ROE. ⛔ 순이익이 음수면 PER 은 null',
    'F5 파일 배달 (09-23) → F8 스크리너 (10-14). ⛔ 스크리너를 자료보다 먼저 만들지 않는다',
    '⚠ 밀린 아카이빙 둘 — broker · stocks. 소급이 안 된다',
  ],
};
