 ...
 * ─────────────────────────────────────────────────────────────────────────
 * SeoulMarkets(금융) · WikiTip(한류) · 백년지도(교육 — 한중일 화교권)
 *
 * [왜 도구로 만드나]
...
const ASSUMPTIONS = {
  ...
  2028: {
    ...
    edu: { 유료구독자: 6_000, 리포트건_월: 1_200 }  /* 한국 + 일본 */,
  ...
  2029: {
    ...
    edu: { 유료구독자: 25_000, 리포트건_월: 5_000 }  /* + 화교권(대만·홍콩·싱가포르) */,
  ...
  2033: {
    ...
    edu: { 유료구독자: 190_000, 리포트건_월: 38_000 } /* 한중일 화교권 전체 */,
...
function markdown() {
  ...
  L.push(
    ...
    `| 백년지도 | ${억표(last.r.EDU)} | ${((last.r.EDU / last.r.total) * 100).toFixed(0)}% |`,
    `| **합계** | **${억표(last.r.total)}** | |`,
    '',
    '---',
    '',
