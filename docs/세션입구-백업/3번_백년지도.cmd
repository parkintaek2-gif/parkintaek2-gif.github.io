@echo off
chcp 65001 >nul
title 3번 백년지도 (100yearmap.com)
REM ────────────────────────────────────────────────────────────
REM  3번 백년지도 (100yearmap.com)
REM  교육·진로. 2번 지휘.
REM
...
claude --resume c8d44208-2f02-4e98-89fa-66533234a10c
if not errorlevel 1 goto :eof
...
set SID=
for /f "usebackq delims=" %%i in (`node "%~dp0_세션ID-찾기.mjs" --id 3`) do set SID=%%i
if not defined SID goto :fresh
if /i "%SID%"=="c8d44208-2f02-4e98-89fa-66533234a10c" goto :eof
...
:fresh
echo.
echo  [!] 3번 세션이 없어졌습니다. 새 대화를 엽니다.
echo      붙여 넣을 것은 없습니다. 창이 열리면 스스로 3번인 것을 압니다.
echo.
