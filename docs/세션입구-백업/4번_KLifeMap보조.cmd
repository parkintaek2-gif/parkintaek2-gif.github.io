...
claude --resume f8e02533-7e53-4e90-a0cd-3575cd7a2b83
if not errorlevel 1 goto :eof
...
set SID=
for /f "usebackq delims=" %%i in (`node "%~dp0_세션ID-찾기.mjs" --id 4`) do set SID=%%i
if not defined SID goto :fresh
if /i "%SID%"=="f8e02533-7e53-4e90-a0cd-3575cd7a2b83" goto :eof
...
:fresh
echo.
echo  [!] 4번 세션이 없어졌습니다. 새 대화를 엽니다.
echo      붙여 넣을 것은 없습니다. 창이 열리면 스스로 4번인 것을 압니다.
echo.
