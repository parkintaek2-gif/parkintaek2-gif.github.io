...
> 기사: https://www.kculturewire.com/article/a-weekly-top-ten-is-not-ten-titles

## X
```
Across 493,600 country-chart rows, 18,586 weekly lists put one title in two or more places.

https://www.kculturewire.com/article/a-weekly-top-ten-is-not-ten-titles
```
⚠ 116자 (한도 280)
...
#Netflix #Measurement #Dataquality #Series #Film #KCultureWire #Kdrama #DataJournalism
```
