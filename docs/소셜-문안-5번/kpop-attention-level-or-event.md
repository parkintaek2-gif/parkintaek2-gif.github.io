...
> 기사: https://www.kculturewire.com/article/kpop-attention-level-or-event

## X
```
For the typical act, the biggest single day is 5.5% of a 30-day month.

https://www.kculturewire.com/article/kpop-attention-level-or-event
```
⚠ 95자 (한도 280)
...
How we counted it, and what it cannot say: https://www.kculturewire.com/article/kpop-attention-level-or-event
```
...
· BTS sits at 25.1%, and all six of its measurable members peaked on the same date.
