...
> 기사: https://www.kculturewire.com/article/same-sign-as-iu

## X
```
We sorted 1,047 Korean actors and singers into the twelve zodiac signs.

https://www.kculturewire.com/article/same-sign-as-iu
```
⚠ 96자 (한도 280)
...
How we counted it, and what it cannot say: https://www.kculturewire.com/article/same-sign-as-iu
```
...
· The spread across the twelve is indistinguishable from chance, and we counted that ourselves.
