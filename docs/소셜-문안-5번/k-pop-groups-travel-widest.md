...
> 기사: https://www.kculturewire.com/article/k-pop-groups-travel-widest

## X
```
K-pop groups come closest to even at 41.7%.

https://www.kculturewire.com/article/k-pop-groups-travel-widest
```
⚠ 68자 (한도 280)
...
How we counted it, and what it cannot say: https://www.kculturewire.com/article/k-pop-groups-travel-widest
```
...
· K-pop groups come closest to even at 41.7%.
· The most concentrated row turned out to be an artefact of Wikipedia, not of attention.
