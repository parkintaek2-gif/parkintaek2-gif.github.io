...
**75 have never appeared on it**, and 20
...
charts.** This file is the two of them joined — 3579 rows saying which person appears in
...
*Squid Game (TV series)* in the encyclopaedia. On Q-numbers it reaches 666 of
942. We spent a day rebuilding this because we had originally stored the count
...
⚠ 276 titles carry no cast statement in Wikidata at all
and are absent here rather than present with an empty cast. 289 of the
1391 people have no English Wikipedia article, so they are in the join but cannot be matched
...
1. **15.9% of viewing sits on titles a foreign work shares a name with.** We mark them; we do not
