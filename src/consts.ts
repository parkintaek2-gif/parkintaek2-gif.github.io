 ...
 *
 * 🔴🔴 **2026-08-05 — 상호 변경등기가 「진행 중」이다. 아직 새 이름을 쓰지 않는다.**
 *
 * ```
 * 지금(등기 완료 전)  주식회사 옆커폰세종 · Yeopkeopon Sejong Co., Ltd.  ← **이것이 법적으로 맞다**
 * 등기 완료 후         주식회사 K라이프디자인 · K Life Design Co., Ltd.
 * 사업자등록번호       456-87-03384 — 법인이 같아 **바뀌지 않는다**
 * ```
 *
 * 사장님이 2026-08-05 에 변경등기를 **접수**하셨다(완료 8/8~8/12 예상).
 * 오전에 내가 새 상호로 먼저 고쳐 놨다가 **되돌렸다** — 금융·교육은 YMYL 이라
 * 발행 주체 표기가 **등기부와 다르면 그게 더 나쁘다.**
 *
 * ✅ 등기가 끝난 날 **아래 두 줄만** 바꾸면 About·푸터·JSON-LD 가 함께 따라간다.
 * ⛔ 그 전에 다른 이유로 배포할 때(예: noindex 해제) **이 값이 딸려 나가지 않게** 한다.
...
export const PUBLISHER = {
  legalName: 'Yeopkeopon Sejong Co., Ltd.',  /* 등기 완료일 → 'K Life Design Co., Ltd.' */
  legalNameKo: '주식회사 옆커폰세종',           /* 등기 완료일 → '주식회사 K라이프디자인' */
