 ...
 * ② **통신판매업 신고번호를 뺐다.** 2026-세종-0591 은 8/28 에 신고한 번호인데
 *   그때 발행 주체는 KLifeDesign 이었고 주소도 보람동이었다(여기는 조치원읍).
 *   **다른 사업자의 번호를 이 상호 아래 적으면 거짓이 된다.** 범진아카데미 명의
 *   신고증을 확인하기 전에는 적지 않는다.
