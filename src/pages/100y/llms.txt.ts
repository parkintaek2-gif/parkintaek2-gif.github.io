...
- [Where our university data has gaps](https://100yearmap.com/university-gap): Of 377 universities/colleges in our employment-rate dataset (KCUE academyinfo.go.kr disclosure), 48 (12.7%) have no employment-rate figure. Breaks down why: 28 are branch campuses (reported under the parent institution), 8 are confirmed-closed schools (cross-checked against a KASFO closed-university list), and 12 remain unexplained — explicitly not guessed at or filled in.
