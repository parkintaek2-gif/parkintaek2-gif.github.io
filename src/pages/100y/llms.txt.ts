...
- [Fall-injury hospital discharges, by age](https://100yearmap.com/fall-injury): KDCA in-depth injury discharge survey (sample-weighted national estimate), ~594,600 fall-injury discharges in 2024, 36.6% aged 75+. Unlike cardiac arrest, women outnumber men. 2015–2024 trend for ages 65+ shows the discharge rate per 100,000 rising from 2,478 to 3,374, dipping in 2020–2021 then climbing again from 2022.
