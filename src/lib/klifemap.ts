...
export const 어른갈래: ReadonlySet<string> = new Set([
  ...
  'marriage-age', 'home', 'spending', 'healthy-years', 'years-left', 'real-wage', 'idle-youth', 'wealth-gap', 'youth-budget-2027', 'nonmarital-birth', 'korea-japan-youth', 'ranking-university', 'ranking-university-founding', 'ranking-university-region', 'ranking-university-level', 'ranking-stock-wealth', 'ranking-apartment-value', 'ranking-hagwon', 'ranking-medical-quota', 'ranking-lawmaker-wealth', 'ranking-kbo-salary', 'ranking-apartment-brand', 'ranking-convenience-brand', 'ranking-tax-delinquent', 'ranking-good-company', 'ranking-vleague-salary', 'ranking-university-nature-index', 'ranking-university-brand', 'sandwich-generation', 'school-type-gap', 'ranking-university-global', 'oecd-elderly-poverty', 'happiness-ranking', 'salary-ranking', 'mental-health', 'senior-doctor', 'high-value-home-age', 'wage-education', 'wage-distribution', 'divorce-age', 'remarriage', 'multicultural-marriage', 'birth-sex-ratio', 'fertility-rate',
  ...
  'happiness-by-age',
  /* 🔴 2026-09-12 3번 신설 — 국회미래연구원 1인가구 증가 대응 방안(3번이 직접 수집) */
  'oneperson-vulnerability',
  /* 🔴 2026-09-14 3번 신설 — 사장님이 직접 전달하신 열린재정 국세 표 vs 실질임금 실측 */
  'tax-vs-wage',
  /* 🔴 2026-09-14 3번 신설 — 국회미래연구원 인구위기와 축소사회 대응 I.총론(3번이 직접 수집) */
  'military-age-men',
  /* 🔴 2026-09-14 3번 신설 — 국회예산정책처 인구위기와 축소사회 대응 II.노동시장(3번이 직접 수집) */
  'labor-market-2072',
  /* 🔴 2026-09-14 3번 신설 — 국회예산정책처 인구위기와 축소사회 대응 III.지방행정재정체제(3번이 직접 수집) */
  ...
  /* 🔴 2026-09-14 3번 신설 — industry-region-cells.json 재활용, 업종별로 묶은 지역 몰림 */
  'industry-region-concentration',
  /* 🔴 2026-09-14 3번 신설 — school-class-size.json 재활용, 학급당 학생수 전국 분포 */
  'class-size-distribution',
  /* 🔴 2026-09-15 3번 신설 — 국가데이터처 KOSIS 국민이전계정, 생애주기적자(3번이 직접 수집) */
  'lifecycle-deficit',
