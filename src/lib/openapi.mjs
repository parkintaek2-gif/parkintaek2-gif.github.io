  ...
  const spec = {
    ...
    info: {
      ...
      description: [
        ...
        `${DICT_STATS.countries} countries) are live and free, along with monthly exports and imports`,
        'by partner country (/trade/exports). The 10-day provisional trade series still opens when',
        'collection begins — until then it returns 404 with a machine-readable reason rather than an',
        'empty array, because "not collected yet" and "no trade occurred" are different answers.',
        '',
      ...
      contact: { name: 'SeoulMarkets', email: 'admin@klifedesign.net', url: `${baseUrl}/api` },
      license: {
